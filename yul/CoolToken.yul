...
object "CoolToken_408" {
    code {
        /// @src 1:101:228  "contract CoolToken is ERC20 {..."
        mstore(64, memoryguard(224))
        if callvalue() { revert_error_ca66f745a3ce8ff40e2ccaf1ad45db7774001b90d25810abd9040049be7bf4bb() }

        constructor_CoolToken_408()

        let _1 := allocate_unbounded()
        codecopy(_1, dataoffset("CoolToken_408_deployed"), datasize("CoolToken_408_deployed"))
        ...
        return(_1, datasize("CoolToken_408_deployed"))
        ...
        /// @ast-id 407
        /// @src 1:136:226  "constructor() ERC20(\"Cool token\", \"COOL\", 18) {..."
        function constructor_CoolToken_408() {
            /// @src 1:156:168  "\"Cool token\""
            ...
            /// @src 1:198:208  "msg.sender"
            let expr_402 := caller()
            /// @src 1:210:218  "10 ether"
            let expr_403 := 0x8ac7230489e80000
            /// @src 1:192:219  "_mint(msg.sender, 10 ether)"
    ...
    object "CoolToken_408_deployed" {
        ...
        data ".metadata" hex"a2646970667358221220b8d0a5d04c4e7cf856d9802d7b80e061cf3c07078311d53a43a1258eff3c481864736f6c63430008100033"
    }
